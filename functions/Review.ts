...
As a final diversion/challenge, check out the code in the
code editor. It contains seven plump, juicy errors. See if you
can use TypeScript to find them all! (You might find it useful
to use the terminal command clear to clear away
TypeScript output you have already dealt with.)
*/
